...
class Atenuacion(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2_punto2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2_punto2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Atenuacion")
        ...
        self._A_win = RangeWidget(self._A_range, self.set_A, "amplitud de la señal", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Atenuacion, options=None):
