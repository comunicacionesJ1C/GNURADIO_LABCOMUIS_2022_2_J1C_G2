...
class potencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "potencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("potencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "potencia")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, a, 0, 0)
...
def main(top_block_cls=potencia, options=None):
