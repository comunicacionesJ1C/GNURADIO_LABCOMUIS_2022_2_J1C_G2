...
# Title: modulador de amplitud J1CG2
# Author: J1CG2
...
class ModuladordeAmplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "modulador de amplitud J1CG2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulador de amplitud J1CG2")
        ...
        self._Ka_win = RangeWidget(self._Ka_range, self.set_Ka, "Coeficiente sencibilidad Ka", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Ka_win)
        self._GTX_range = Range(0, 30, 1, 0, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganasia Trasmisor", "counter_slider", float, QtCore.Qt.Horizontal)
